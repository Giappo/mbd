...
### 6.2. More intuitive interface

If you want for example to maximize the likelihood only for the parameter q,
using a more type-safe interface, call `mbd_calc_max_lik`:
