...
First, we bundle our initial parameter values:
...
To indicate which parameters we want to fix:
...
To indicate which parameters we want to optimize:
...
Then we can call `mbd_calc_max_lik`:
